...
RUN	git clone https://github.com/sherkitty/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/sherkitty/sherkitty
...
if [ ! -d sigs ]; then
	git clone https://github.com/sherkitty/gitian.sigs.git sigs
	cd sigs
