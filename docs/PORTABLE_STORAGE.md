...
[epee](https://github.com/sherkitty/sherkitty/tree/master/contrib/epee). Part
of this library implements a networking protocol called
[Levin](https://github.com/sherkitty/sherkitty/blob/master/contrib/epee/include/net/levin_base.h),
which internally uses a storage format called [Portable
Storage](https://github.com/sherkitty/sherkitty/tree/master/contrib/epee/include/storages).
This format (amongst the rest of the
[epee](https://github.com/sherkitty/sherkitty/tree/master/contrib/epee)
...
- [Core RPC
  definitions](https://github.com/sherkitty/sherkitty/blob/master/src/rpc/core_rpc_server_commands_defs.h)
- [CryptoNote protocol
  definitions](https://github.com/sherkitty/sherkitty/blob/master/src/cryptonote_protocol/cryptonote_protocol_defs.h)
