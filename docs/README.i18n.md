Sherkitty daemon internationalization
==================================
...
In order to use the same translation workflow as the [Sherkitty Core GUI](https://github.com/sherkitty/sherkitty-gui), they use Qt Linguist translation files.  However, to avoid the dependencies on Qt this normally implies, they use a custom loader to read those files at runtime.
